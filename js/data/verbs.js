    ...
    const verbStudyGroups = [
      ...
      },
      {
        ...
        descriptionHtml: "<strong>Dormir, partir, sortir, servir,</strong> and <strong>sentir</strong> share a useful pattern: singular forms drop part of the stem, while plural forms bring it back. Hear the final consonant return in <strong>dors /dɔʁ/ → dormons /dɔʁ.mɔ̃/</strong> and <strong>pars /paʁ/ → partons /paʁ.tɔ̃/</strong>."
      },
      {
        key: "regularEr",
      ...
      },
      {
        ...
        descriptionHtml: "These verbs follow the <strong>finir</strong> pattern: <strong>-is, -is, -it, -issons, -issez, -issent</strong>. The singular endings are silent and sound alike; the plural forms pronounce the <strong>-iss-</strong> stem: <strong>finit /fi.ni/ → finissons /fi.ni.sɔ̃/ → finissent /fi.nis/</strong>. This differs from irregular <strong>-ir</strong> verbs like <strong>venir</strong>, <strong>tenir</strong>, <strong>dormir</strong>, and <strong>partir</strong>."
      },
      {
        key: "regularRe",
    ...
    const presentVerbHighlights = {
      etreVerb: ["The six forms use several sounds: <strong>suis /sɥi/</strong>, <strong>es / est /ɛ/</strong>, <strong>sommes /sɔm/</strong>, <strong>êtes /ɛt/</strong>, and <strong>sont /sɔ̃/</strong>. Learn each as a unit."],
      avoirVerb: ["The present changes sharply across <strong>j’ai /ʒe/</strong>, <strong>tu as /ty a/</strong>, <strong>nous avons /nu.za.vɔ̃/</strong>, and <strong>ils ont /il.zɔ̃/</strong>. Before these vowel-initial forms, the final consonant of <strong>nous, vous, ils,</strong> or <strong>elles</strong> links as <strong>/z/</strong>."],
      aller: ["Three sound patterns appear: <strong>vais /vɛ/</strong>, <strong>vas / va /va/</strong>, <strong>allons /a.lɔ̃/</strong>, <strong>allez /a.le/</strong>, and <strong>vont /vɔ̃/</strong>."],
      venir: ["The stem and vowel move across <strong>viens / vient /vjɛ̃/</strong>, <strong>venons /və.nɔ̃/</strong>, and <strong>viennent /vjɛn/</strong>."],
      revenir: ["Like <strong>venir</strong>: <strong>reviens /ʁə.vjɛ̃/</strong>, <strong>revenons /ʁə.və.nɔ̃/</strong>, and <strong>reviennent /ʁə.vjɛn/</strong> use three audible stem shapes."],
      devenir: ["Like <strong>venir</strong>: <strong>deviens /də.vjɛ̃/</strong>, <strong>devenons /də.və.nɔ̃/</strong>, and <strong>deviennent /də.vjɛn/</strong> use three audible stem shapes."],
      tenir: ["The <strong>venir</strong> pattern repeats: <strong>tiens / tient /tjɛ̃/</strong>, <strong>tenons /tə.nɔ̃/</strong>, and <strong>tiennent /tjɛn/</strong>."],
      prendre: ["Hear three present stems: <strong>prends / prend /pʁɑ̃/</strong>, <strong>prenons /pʁə.nɔ̃/</strong>, and <strong>prennent /pʁɛn/</strong>. The final <strong>d</strong> in the singular is silent."],
      ...
      savoir: ["The stem changes across <strong>sais / sait /sɛ/</strong>, <strong>savons /sa.vɔ̃/</strong>, <strong>savez /sa.ve/</strong>, and <strong>savent /sav/</strong>."],
      connaitre: ["The final consonant becomes audible in plural forms: <strong>connais / connaît /kɔ.nɛ/</strong>, but <strong>connaissons /kɔ.nɛ.sɔ̃/</strong> and <strong>connaissent /kɔ.nɛs/</strong>."],
      seConnaitre: ["The same contrast appears after the reflexive pronoun: <strong>se connaît /kɔ.nɛ/</strong>, but <strong>nous nous connaissons /kɔ.nɛ.sɔ̃/</strong> and <strong>se connaissent /kɔ.nɛs/</strong>."],
      croire: ["The singular and ils/elles forms use <strong>/kʁwa/</strong>. The pronounced <strong>y</strong> creates <strong>/j/</strong> in <strong>croyons /kʁwa.jɔ̃/</strong> and <strong>croyez /kʁwa.je/</strong>."],
      voir: ["The singular and ils/elles forms use <strong>/vwa/</strong>, while <strong>voyons /vwa.jɔ̃/</strong> and <strong>voyez /vwa.je/</strong> add the audible <strong>/j/</strong>."],
      seVoir: ["The singular and ils/elles forms use <strong>/vwa/</strong>, while <strong>nous nous voyons /vwa.jɔ̃/</strong> and <strong>vous vous voyez /vwa.je/</strong> add <strong>/j/</strong>."],
      boire: ["Three sounds appear: <strong>bois / boit /bwa/</strong>, <strong>buvons /by.vɔ̃/</strong>, <strong>buvez /by.ve/</strong>, and <strong>boivent /bwav/</strong>."],
      dire: ["Compare <strong>dis / dit /di/</strong>, <strong>disons /di.zɔ̃/</strong>, <strong>dites /dit/</strong>, and <strong>disent /diz/</strong>. The vous form is not <strong>*disez</strong>."],
      seDire: ["Compare <strong>se dit /di/</strong>, <strong>nous nous disons /di.zɔ̃/</strong>, <strong>vous vous dites /dit/</strong>, and <strong>se disent /diz/</strong>."],
      suivre: ["The singular stops at <strong>/sɥi/</strong> in <strong>suis / suit</strong>. The stem-final <strong>v</strong> becomes audible in <strong>suivons /sɥi.vɔ̃/</strong> and <strong>suivent /sɥiv/</strong>."],
      vivre: ["The final <strong>v</strong> is absent from <strong>vis / vit /vi/</strong> but audible in <strong>vivons /vi.vɔ̃/</strong> and <strong>vivent /viv/</strong>."],
      ecrire: ["The stem-final <strong>v</strong> appears in plural forms: <strong>écris / écrit /e.kʁi/</strong>, but <strong>écrivons /e.kʁi.vɔ̃/</strong> and <strong>écrivent /e.kʁiv/</strong>."],
      lire: ["The stem-final <strong>s</strong> becomes <strong>/z/</strong> in plural forms: <strong>lis / lit /li/</strong>, but <strong>lisons /li.zɔ̃/</strong> and <strong>lisent /liz/</strong>."],
      naitre: ["The singular is <strong>nais / naît /nɛ/</strong>; the <strong>s</strong> becomes audible in <strong>naissons /nɛ.sɔ̃/</strong> and <strong>naissent /nɛs/</strong>."],
      ...
      offrir: ["Despite ending in <strong>-ir</strong>, <strong>offrir</strong> uses present endings like an <strong>-er</strong> verb: <strong>j’offre, nous offrons, ils offrent</strong>."],
      ouvrir: ["Despite ending in <strong>-ir</strong>, <strong>ouvrir</strong> uses present endings like an <strong>-er</strong> verb: <strong>j’ouvre, nous ouvrons, ils ouvrent</strong>."],
      eteindre: ["The nasal singular is <strong>éteins / éteint /e.tɛ̃/</strong>. The stem changes to pronounced <strong>/ɲ/</strong> in <strong>éteignons /e.tɛ.ɲɔ̃/</strong>, <strong>éteignez /e.tɛ.ɲe/</strong>, and <strong>éteignent /e.tɛɲ/</strong>."],
      ...
      sEnnuyer: ["The <strong>y</strong> becomes <strong>i</strong> before silent <strong>e</strong>: <strong>s’ennuie /ɑ̃.nɥi/</strong>. It stays <strong>y</strong> and adds <strong>/j/</strong> before pronounced endings: <strong>ennuyons /ɑ̃.nɥi.jɔ̃/</strong>, <strong>ennuyez /ɑ̃.nɥi.je/</strong>."],
      sInquieter: ["The accent signals a real vowel change: <strong>inquiète / inquiètent /ɛ̃.kjɛt/</strong> use open <strong>/ɛ/</strong>, while <strong>inquiétons /ɛ̃.kje.tɔ̃/</strong> and <strong>inquiétez /ɛ̃.kje.te/</strong> use closed <strong>/e/</strong>."],
      seDetendre: ["The final <strong>d</strong> is silent in <strong>se détend /de.tɑ̃/</strong> but audible in <strong>nous nous détendons /de.tɑ̃.dɔ̃/</strong> and <strong>se détendent /de.tɑ̃d/</strong>."]
    };
